	...
	<nav id="navbar"
		...
		<div id="navb" class="navbar-collapse collapse">
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link w3-hover-teal"
					href="${pageContext.request.contextPath}/addfriend">Add a
						Friend</a></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle w3-hover-teal" href="#"
					id="navbardrop" data-toggle="dropdown">Settings</a>


					<div class="dropdown-menu">
						<a class="dropdown-item w3-hover-teal"
							href="${pageContext.request.contextPath}/profile">Profile</a> <a
							class="dropdown-item w3-hover-teal"
							href="${pageContext.request.contextPath}/settings">Settings</a> <a
							class="dropdown-item w3-hover-teal"
